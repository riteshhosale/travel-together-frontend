        ...
        <div className="fg-footer-shell grid gap-8 lg:grid-cols-[1.3fr_0.8fr_0.8fr_0.9fr]">
          <div className="space-y-4">
            ...
            <p className="fg-muted max-w-md text-sm">
              A cleaner, smarter way to discover trips, coordinate with travel companions,
              and plan your entire journey from one place.
            </p>
          </div>
          ...
          <nav className="flex flex-col gap-3">
            ...
            <Link to="/feed" className="fg-nav-link text-sm">Community Feed</Link>
          </nav>
          ...
          <nav className="flex flex-col gap-3">
            ...
            <Link to="/gps" className="fg-nav-link text-sm">GPS Navigator</Link>
          ...
          <div className="space-y-3">
            ...
            <p className="fg-muted text-sm">
              Designed to feel less like a student project and more like a polished
              travel product people would actually trust and use.
            </p>
