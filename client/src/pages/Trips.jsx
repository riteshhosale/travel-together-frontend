  ...
  return (
    <div className="fg-page min-h-screen px-4 py-10 sm:py-12">
      ...
      <div className="fg-page-content mx-auto w-full max-w-6xl fg-rise">
        ...
        {trips.some(
          (trip) => trip.canManageTrip === true || trip.viewerRole === "admin",
        ) && (
          <div className="fg-card mb-6 border border-cyan-400/25 p-5">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              {trips
                .filter(
                  (trip) =>
                    trip.canManageTrip === true || trip.viewerRole === "admin",
                )
                .slice(0, 3)
                .map((trip) => (
                  <button
        ...
        {isLoading ? (
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {trips.map((trip) => {
              const memberCount =
                memberCounts[trip._id] ?? getTripMemberCount(trip);
                              ...
                              prev.map((item) =>
                                item._id === trip._id
                                  ? {
                                      ...
                                      viewerRole:
                                        joinResult.viewerRole ||
                                        item.viewerRole,
                                      canManageTrip:
                                        typeof joinResult.canManageTrip ===
                                        "boolean"
